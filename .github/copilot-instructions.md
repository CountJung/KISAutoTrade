...
Codex에서는 루트 `AGENTS.md`를 최상위 지침으로 사용하고, 로컬 브리지 스킬 `~/.codex/skills/kisautotrade-*`가 현재 작업 저장소 루트 기준으로 `.github/skills/**/SKILL.md` 원본을 다시 읽도록 구성되어 있습니다. 스킬 내용을 수정할 때는 로컬 브리지가 아니라 저장소의 원본 `.github/skills/**/SKILL.md`를 갱신하세요.
