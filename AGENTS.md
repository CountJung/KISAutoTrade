...
| 날짜 | 한줄 요약 |
|------|----------|
| 2026-07-08 | 레버리지 전략에 급반등 단독 진입 옵션과 설정 UI 추가 |
| 2026-07-08 | 모든 일반 자동전략 카드에 저장 전 파라미터 기반 미리보기 패널 추가 |
| 2026-07-08 | 레버리지 전략 미리보기 차트에 Toss 종가 선 그래프 오버레이 추가 |
| 2026-07-08 | 레버리지 반등 실패 손절을 최소 보유 이후로 보정하고 일일 매수 제한 해제 |
| 2026-07-08 | AppShell 메인 스크롤 위치를 route별로 복원하도록 개선 |
